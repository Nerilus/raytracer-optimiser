...
# Script pour créer le profil final après optimisations
...
PROFILE_DIR="profiling/final"

echo "========================================="
echo "  PROFILAGE FINAL - APRÈS OPTIMISATIONS"
echo "========================================="
echo ""
echo "Scène: $SCENE"
...
echo "📊 Étape 1: Mesure du temps d'exécution final..."
echo "----------------------------------------"
...
echo "📊 Étape 2: Profilage avec Callgrind..."
echo "----------------------------------------"
...
echo ""
echo "Prochaine étape: Exécutez ./compare_profiles.sh"
echo ""
